		...
		<table width="80%" align="center" class="reserveOption">
			...
			<tr id="line">
				<td colspan="4" align="center" id="line">
					조식 인원 수 (1인당 20,000원) : 
					<input type="number" name="option" style="background-color:#e7eaed; text-align:center;" name="breakfast" id="input" size="5" min="0" max='${param.adults + param.kids - "" }' />&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
				<td colspan="4" align="center">
					<input type="submit" id="btn" class="btn btn-outline-primary"  value="예약하기" />
					<input type="reset" id="btn" class="btn btn-outline-primary" value="취소" onclick="location.href='/reservation'" />
				</td>
			</tr>
		</table>
