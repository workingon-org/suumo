	...
	<nav class="navbar navbar-expand-lg bg-light">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				<a class="navbar-brand" href="http://localhost:8080/room/Royal">로열</a>
			...
			<div id="carouselExampleIndicators" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img
							src="${contextpath}/resources/img/royalsuite1.jpg"
							class="d-block w-70">
					</div>
					<div class="carousel-item">
						<img
							src="${contextpath}/resources/img/royalsuite3.jpg"
							class="d-block w-70">
					</div>
					<div class="carousel-item">
						<img
							src="${contextpath}/resources/img/royalsuite4.jpg"
							class="d-block w-70">
					</div>
				</div>
        ...
        <div class="col-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">로열 룸은 여유로운 응접실과 다이닝 룸, 
              		침실로 구성된 고급스러운 공간입니다.</p>
