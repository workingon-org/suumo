	...
	<nav class="navbar navbar-expand-lg bg-light">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				<a class="navbar-brand" href="http://localhost:8080/room/Standard">스탠다드</a>
			...
			<div id="carouselExampleIndicators" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img
							src="${contextpath}/resources/img/nikkopremium_twn西_夜21.jpg"
							class="d-block w-70">
					</div>
					<div class="carousel-item">
						<img
							src="${contextpath}/resources/img/nikko-premium-executive-suite_990x5901.jpg"
							class="d-block w-70">
					</div>
					<div class="carousel-item">
						<img
							src="${contextpath}/resources/img/superior-twin_990x5901.jpg"
							class="d-block w-70">
					</div>
				</div>
        ...
        <div class="col-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">스탠다드 룸은 편안함과 쾌적함이
				인상적인 최상의 휴식 환경을 제공합니다.</p>
