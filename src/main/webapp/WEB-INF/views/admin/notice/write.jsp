...
<div class="container" style="margin-bottom: 50px;">
	<div style="width: 60%; margin: auto;">
		<form style="border-top: 2px solid #353535;" id="form" role="form" method="post" action="/admin/notice/save" onSubmit="return Checkform()" name="frm">
			<div style="width: 100%; border-bottom: solid 1px #353535;">
				...
				<div style="margin-left: 20%; height: 36px; width: 100%;">
					...
					<input type="text" style="width: 80%; height: 36px; border: none; margin-left: 15px;" name="title" id="title" placeholder="TITLE을 입력해 주세요">
				</div>
			</div>
			<div style="width: 100%;">
				...
				<div style="line-height: 39px; width: 27%; float: left; margin-right: 0px; height: 35px; font-size: 14px; background-color: white; padding-left: 20px; text-align: left;">${currentTime}</div>
			...
			<div>
				<textarea style="width: 100%; height: 400px; padding-top: 30px; border: none; border-top: 1px solid gray; border-bottom: 2px solid black" rows="5" name="content" placeholder="내용을 입력해 주세요"></textarea>
			</div>
